...
public class DashboardPage extends WebUI{
    ...
    public void clickButtonDashboardOptions(){
        ...
        System.out.println(this.checkElementExist(driver, buttonDashboardOptions));
    ...
    public void checkTotalInvoicesAwaitingPayment() {
        this.waitForPageLoaded(driver);
        Assert.assertTrue(this.checkElementExist(driver, totalInvoicesAwaitingPayment), "The section Invoices Awaiting Payment not display.");
    ...
    public void checkTotalConvertedLeads() {
        this.waitForPageLoaded(driver);
        Assert.assertTrue(this.checkElementExist(driver, totalConvertedLeads), "The section Converted Leads not display.");
    ...
    public void checkTotalProjectsInProgress() {
        this.waitForPageLoaded(driver);
        Assert.assertTrue(this.checkElementExist(driver, totalProjectsInProgress), "The section Projects In Progress not display.");
    ...
    public void checkTotalTasksNotFinished() {
        this.waitForPageLoaded(driver);
        Assert.assertTrue(this.checkElementExist(driver, totalTasksNotFinished), "The section Tasks Not Finished not display.");
